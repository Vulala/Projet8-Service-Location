package tourguide.service.location.service;
...
import tourguide.service.location.user.NearbyAttractions;
...
public class LocationService {
	...
	public Map<Double, String> distanceBetweenUserAndAttraction(User user) {
		...
		List<Attraction> nearbyAttractionsFromUser = getNearByAttractions(getUserLocation(user));
